...
public class AGG13 extends TestHarness {
  public static void main(String args[]) {
    TestHarness.main(args, new AGG13());
  }
  public void testRA() {
    ...
    query_0.addAggregate(new AggregateNode.AggColumn("Sum", new ExprTree(ExprTree.OpCode.ADD, new ExprTree.VarLeaf(null, "A"), new ExprTree(ExprTree.OpCode.ADD,new ExprTree.VarLeaf(null, "C"),new ExprTree.VarLeaf(null, "B"))),AggregateNode.AType.SUM));
    ...
    System.out.println("Passed RA Test AGG13");
  }
  public void testSQL() {
    List<List<Datum[]>> expected = new ArrayList<List<Datum[]>>();
    expected.add(getResults0());
    TestHarness.testProgram(new File("test/AGG13.SQL"),
                            expected);
    System.out.println("Passed SQL Test AGG13");
  }
  ArrayList<Datum[]> getResults0() {
    ArrayList<Datum[]> ret = new ArrayList<Datum[]>();
    ret.add(new Datum[] {new Datum.Int(167), new Datum.Flt(5.6842103)}); 
    return ret;
  }
}
